...
<!--Panel lateral-->
        ...
        <div id="logocategoria">Categor�a: CC T�cnicas y Divulgaci�n Cient�fica</div>
		<div id="body">
			<div class="inner">
                 <div class="leftbox">
					<h3><b>�Cu�nto vale la x?</b></h3>
...
<!-- / leftbox -->
				<div class="rightbox">
					<h3><b>Por amor a la F�sica</b> </h3>
...
<!-- / leftbox -->
				<div class="rightbox">
					...
					<p>Autor:<b> Sebastian Franchini; Óscar López García</b></p>
...
<!-- / leftbox -->
				<div class="rightbox">
					<h3><b>La Química en la vida cotidiana</b></h3>
