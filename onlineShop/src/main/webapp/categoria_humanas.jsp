...
<!--Panel lateral-->
        ...
        <div id="logocategoria">CategorÌa: Ciencias Humanas</div>
		<div id="body">
			<div class="inner">
                 <div class="leftbox">
...
<!-- / leftbox -->
				<div class="rightbox">
					<h3><b>La ciudad y el hombre</b></h3>
					<img src="images/cchumanas_ciudadhombre.jpg" width="100" height="152" alt="photo 6" class="left" />
					<p>Autor: <b>Leo Strauss</b></p>
                    <p>ISBN: 9788460983514</p>
                    <p>Precio: <b>22,60 EUR</b>.</p>
					<p class="readmore"><a href="#"><b>AÒadir al carrito</b></a></p>
					<div class="clear"></div>
				</div>
