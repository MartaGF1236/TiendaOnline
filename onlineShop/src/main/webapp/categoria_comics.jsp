...
<!--Panel lateral-->
        <div id="logocategoria">Categor�a: C�mics y revistas</div>
		<div id="body">
			<div class="inner">
                 <div class="leftbox">
...
<!-- / leftbox -->
				<div class="rightbox">
					<h3><b>El fantasma de la Ópera</b></h3>
...
<!-- / rightbox -->
				...
				<div class="leftbox">
					<h3><b>Spiderman y la Gata Negra (Marvel Deluxe)</b></h3>
					<img src="images/comic_spidermangatanegra.jpg" width="100" height="150" alt="photo 2" class="left" />
...
<!-- / leftbox -->
				<div class="rightbox">
					<h3><b>National Geographic 125 años</b></h3>
					<img src="images/revista_nationalgeographic.jpg" width="110" height="135" alt="photo 5" class="left" />
