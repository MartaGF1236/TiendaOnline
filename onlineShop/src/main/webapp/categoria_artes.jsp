...
<!--Panel lateral-->
        ...
        <div id="logocategoria">Categoría: Artes escénicas, Cine y Poesía.</div>
		<div id="body">
			<div class="inner">
                 <div class="leftbox">
...
<!-- / rightbox -->
				...
				<div class="leftbox">
					<h3><b>La danza del vientre paso a paso</b> </h3>
					<img src="images/danza_danzadelvientre.jpg" width="100" height="135" alt="photo 2" class="left" />
					<p>Autor: <b>Laura Cooper</b></p>
                    <p>ISBN: 9788441416451</p>
                    <p>Precio: <b>5,95 EUR</b>.</p>
					<p class="readmore"><a href="#"><b>Añadir al carrito</b></a></p>
					<div class="clear"></div>
				</div>
<!-- / leftbox -->
